...
int main() {
    mainF();
    //interval afterSwan = swan2(START_POINT);
    /*printf("Resulting interval after swan2's method: [ %f ; %f ]\n", afterSwan.a, afterSwan.b);

    printf("Result of working's consequence of methods swan-bolzano - golden ratio 1: %f\n",
           goldenRatio1(
                   afterSwan.a,
                   afterSwan.b));

    printf("Result of working's linear interpolation: %f\n",
           linearInterp(
                   afterSwan.a,
                   afterSwan.b,
                   0));

    printf("Result of working's interpoltion by cubic polynomial: %f\n",
           cubInterp(
                   afterSwan.a,
                   afterSwan.b,
                   0));
